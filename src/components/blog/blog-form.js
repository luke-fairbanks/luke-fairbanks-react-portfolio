...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://lukefairbanks.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post",
        }
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({
                ...
                apiUrl: `https://lukefairbanks.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
                apiAction: "patch",
            });
        }
    }
    ...
    render() {
        return (
            <form onSubmit={this.handleSumbit} className="blog-form-wrapper">
